...
window.__CERTF__ = {
  ...
  "certs": [
    ...
    { "id": "aws-exam-benefit", "n": "AWS Exam Pass Benefit (50% en tu siguiente examen)", "i": "AWS", "p": 7, "c": "Cloud", "t": "descuento", "disc": 50, "kind": "cert",
      ...
      "note": "Beneficio permanente, no una promoción: encadena CLF → SAA → Developer y baja de US$400 a ≈US$250. El voucher llega por correo a los pocos días de aprobar." },
  ...
  "tips": [
    ...
    "AWS Exam Pass Benefit: cada examen aprobado te da 50% en el siguiente por 12 meses. Encadena CLF → SAA → Developer y ahorras ≈US$150.",
